...
if (!clerkSecretKey) {
    console.warn("Missing CLERK_SECRET_KEY in environment variables. Authentication will not work.");
}

export const clerkClient = clerkSecretKey ? Clerk({ secretKey: clerkSecretKey }) : null;
